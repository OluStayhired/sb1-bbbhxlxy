...
<footer className="mt-24 border-t border-gray-300 text-left">
  ...
  {/* Care Tools & Resources */}
      <div className="col-span-1">
        ...
        <ul className="space-y-2 text-sm text-gray-600">
          <li> <a href="https://poetiq.io/dev/nursing_home" className="no-underline hover:text-red-400 transition-colors">Nursing Home Finder 🎯</a></li>
          <li> <a href="#" className="no-underline hover:text-red-400 transition-colors">Caregivers Near Me 📌 </a></li>    
