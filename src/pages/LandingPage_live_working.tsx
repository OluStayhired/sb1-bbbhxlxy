          ...
          {/*start alternative header */}
            ...
            <p> 
              <span className="inline-block bg-gradient-to-l from-blue-400 via-blue-600 to-blue-800 text-transparent bg-clip-text mt-6">
                Meet your <br className="sm:hidden" /> social media manager <br className="sm:hidden" />
                
    <p className="block font-semibold text-lg sm:font-semibold text-xl sm:text-xl md:text-xl lg:text-4xl text-gray-700 leading-tight mt-1 sm:mt-3">
...
{/*----------------- Start Video Section for SoSavvy ----------------------- */}
        ...
        <p className="text-xl sm:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto">
          ...
          {/*<br/> Generate client engaging posts with zero effort.*/}
...
*/}
        ...
        */}
          ...
          <img
            ...
            //src="https://selrznkggmoxbpflzwjz.supabase.co/storage/v1/object/public/user-post-images/v3_sosavvy_dashboard.png"
            //src="https://selrznkggmoxbpflzwjz.supabase.co/storage/v1/object/public/user-post-images/v4_sosavvy_dashboard.png"
        ...
        <div className="text-left md:pl-8">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center">
              ...
              <CheckCircle className="w-6 h-6 text-white mr-3 flex-shrink-0" />
               <TooltipExtended text="⚡Bulk Schedule content for 14 Or 28 days depending on the number of calendars you created"> 
