      ...
      <div className="bg-white rounded-xl p-8 w-full max-w-lg relative shadow-2xl border-2 border-red-100">
        ...
        <div className="mb-8 space-y-4">
          <p className="text-gray-700 text-base leading-relaxed">
            You shouldn't have to watch a lifetime of hard-earned success evaporate into <span className="font-semibold text-red-500">$10k monthly care bills</span>. 
            We've combined specialized financial modeling with an elite network of elder law attorneys to audit predatory contracts, appeal medicaid application rejections and unlock alternative funding.
          </p>
