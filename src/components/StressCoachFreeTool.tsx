// src/components/StressCoachFreeTool.tsx
    ...
    try {
      ...
      if (!geminiResponse.error && geminiResponse.text) {
        ...
        const errorMessage: Message = {
          id: (Date.now() + 1).toString(),
          role: 'assistant',
          content: "I'm having trouble processing that right now. Could you please try rephrasing your question about caregiving conflicts?",
          timestamp: new Date()
        };
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 rounded-lg p-4 border border-red-100">
                <form onSubmit={handleEmailSubmit} className="flex items-center space-x-3">
                  ...
                  <input
                    ...
                    placeholder="Get actionable caregiving tips via email"
...
export default StressCoachFreeTool;
