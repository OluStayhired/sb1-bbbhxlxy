...
import { OnboardingQuestionsModal } from './OnboardingQuestionsModal';
...
export function EldercareModalPopUp({ isOpen, onClose }: EldercareModalPopUpProps) {
  ...
  const handleOpenOnboarding = () => {
    ...
    onClose(); // Close the popup modal when opening the onboarding
  };
  ...
  return (
    <>
      ...
      >
        <div className="bg-gray-900 rounded-2xl shadow-2xl w-[420px] relative overflow-hidden border border-gray-800 animate-bounce-subtle">
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-4">
              ...
              <div className="mb-4 pb-4 border-b border-gray-800">
                <p className="text-lg font-bold text-red-400 leading-tight">
                  Avoid a $100,000/Year Care Liability
                </p>
              </div>
            ...
            <div className="flex flex-col items-center space-y-3">
              <button
                ...
                className="w-full px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white text-base font-bold rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-300 shadow-xl shadow-red-500/30 hover:shadow-2xl hover:shadow-red-500/50 hover:scale-105 active:scale-95 transform"
              >
...
export default EldercareModalPopUp;
