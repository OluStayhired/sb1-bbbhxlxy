...
import { geminiSPACoPilot } from '../lib/geminiSPACoPilot';
import { TooltipHelp } from '/src/utils/TooltipHelp';
import { TooltipExtended } from '/src/utils/TooltipExtended';
import { TooltipBoundary } from '/src/utils/TooltipBoundary';
...
export function SPACoPilotPillModal() {
  ...
  const handleSendMessage = async (content: string) => {
    ...
    try {
      ...
      const geminiResponse = await geminiSPACoPilot(content, '800');
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 border-b border-red-400">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-xs text-red-100 font-medium">Clinical & Financial Co-Pilot</p>
                </div>
              </div>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      <p className="text-xs text-gray-700 leading-relaxed">
                        ...
                        <span className="font-semibold text-red-600">Forensic intelligence at your fingertips.</span> I share defensible clinical data and Medicaid logic you need to validate placements and bypass manual research.
                      </p>                 
                    </div>
                  </div>
                </div>
...
export default SPACoPilotPillModal;
